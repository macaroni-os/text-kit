...
SRC_URI="
https://download.gnome.org/sources/papers/49/papers-49.4.tar.xz -> papers-49.4.tar.xz
mirror://macaroni/papers-49.4-mark-rust-bundle.tar.xz -> papers-49.4-mark-rust-bundle.tar.xz"
LICENSE="LGPL-2.1+"
SLOT="0"
KEYWORDS="*"
