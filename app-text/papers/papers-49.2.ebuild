...
SRC_URI="
https://download.gnome.org/sources/papers/49/papers-49.2.tar.xz -> papers-49.2.tar.xz
mirror://macaroni/papers-49.2-mark-rust-bundle.tar.xz -> papers-49.2-mark-rust-bundle.tar.xz"
LICENSE="LGPL-2.1+"
SLOT="0"
KEYWORDS="*"
